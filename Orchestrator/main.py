...
def agent_loop(prompt: str):
    ...
    doc_memory.chat_memory.messages.insert(
        0, SystemMessage(content=doc_prompt)
    )

    opt_memory.chat_memory.messages.insert(
        0, SystemMessage(content=opt_prompt)
    )

    review_memory.chat_memory.messages.insert(
