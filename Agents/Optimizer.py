...
prompt = '''You are working in an organization responsible for improving the given code. You are assigned with the task of optimizing the time space complexity of the code in the best possible manner. Your name is Optimizer.
